...
public class HW2 {
    ...
    public static void main(String[] args) {
		...
		do {
			...
			//First Choice Allow You To Insert Coins
			if (intChoice == 1) {
				do {
					intChoice = 0;
					System.out.println("-----------------------------------------------");
			...
			//Second Choice Checks Card Number
			else if (intChoice == 2) {
				System.out.println();
			...
			//Enter Service Menu
				...
				do {
					...
					intChoice = input.nextInt();
					//Choice Decides On Coin Storage
					if (intChoice == 1) {
					...
					//Empty The Entire Vending Machine
					else if(intChoice == 2) {
						System.out.println();
					...
					//Allow Person To Change Pricing
					else if(intChoice == 4) {
